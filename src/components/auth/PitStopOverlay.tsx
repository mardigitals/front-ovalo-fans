...
const PitStopOverlay = () => {
  ...
  if (location.pathname.includes('/dashboard/mi-cuenta') || location.pathname.includes('/dashboard/pagos') || location.pathname.includes('/dashboard/comercios') || location.pathname.includes('/dashboard/mi-perfil')) return null;
