...
const TermsConditionsPage = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-12">
      ...
      {/* Botón de volver usando tu estilo de link */}
      <Link to="/" className="mb-8 inline-block text-slate-500 hover:text-sky-500 transition-colors text-sm font-medium">
        &larr; Volver al inicio
      </Link>

      <h1 className="title-fan mb-8">Términos y Condiciones de Membresía</h1>
