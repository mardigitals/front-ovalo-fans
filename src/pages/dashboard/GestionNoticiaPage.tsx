...
import { X, FileText, Image as ImageIcon, CheckCircle, Search, Trash2, Pencil } from 'lucide-react';
...
const GestionNoticiasPage = () => {
    ...
    return (
        ...
        <ConfirmDeleteModal 
            ...
            itemName={noticiaAEliminar?.titulo || ''} 
            warningText="Esta acción no se puede deshacer y borrará la noticia del portal público."
        />
    </div>
  );
};
